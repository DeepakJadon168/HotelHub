...
// ✅ Use this await-style version instead
module.exports.signup = async (req, res, next) => {
    try {
        const { username, email, password, phone, role, gender, organization } = req.body;

        const newUser = new User({ email, username, phone, role, gender, organization });
        const registeredUser = await User.register(newUser, password); // ✅ await, no callback
